          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup activecondition={pathname === '/' || pathname.includes('dashboard')}>
                ...
                {/* Service Agency */}
                <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('serviceagency') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/serviceagency"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes('serviceagency') ? 'hover:text-slate-200' : 'hover:text-white'
                  }`}
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current ${pathname.includes('serviceagency') ? 'text-indigo-500' : 'text-slate-600'}`}
